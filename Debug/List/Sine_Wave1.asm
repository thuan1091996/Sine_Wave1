...
; 0000 005E     Freq_load=800;                    //10Khz, F_timer2 = 2*F_signal2  (Timer1 OVR -> 50Khz)
	__GETD1N 0x320
	STS  _Freq_load,R30
	STS  _Freq_load+1,R31
	STS  _Freq_load+2,R22
	STS  _Freq_load+3,R23
...
SUBOPT_0x0:
	LDS  R26,_Freq_load
	LDS  R27,_Freq_load+1
	LDS  R24,_Freq_load+2
	LDS  R25,_Freq_load+3
	RET
